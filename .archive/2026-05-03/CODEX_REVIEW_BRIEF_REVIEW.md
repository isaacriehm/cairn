...
1. **Severity:** should-revisit-soon  
   **Location:** [FILESYSTEM_LAYOUT.md §0](<operator-home>/Cairn/docs/FILESYSTEM_LAYOUT.md:22), [RESUME_PROMPT.md L08](<operator-home>/Cairn/RESUME_PROMPT.md:74)  
...
2. **Severity:** should-revisit-soon  
   **Location:** [PRIMER.md §4.3](<operator-home>/Cairn/docs/PRIMER.md:216), [FILESYSTEM_LAYOUT.md §3](<operator-home>/Cairn/docs/FILESYSTEM_LAYOUT.md:190)  
   ...
   **Suggested resolution:** Add a draft-doc exemption or update the Cairn docs now so the harness dogfoods its own rule.  
   **Evidence:** “Frontmatter required on every load-bearing markdown.”

**Missing Assumptions**

3. **Severity:** must-fix-before-build  
   **Location:** [PRIMER.md §5.5](<operator-home>/Cairn/docs/PRIMER.md:291), [INTEGRATION_PLAN.md §6.4](<operator-home>/Cairn/docs/INTEGRATION_PLAN.md:507)  
...
4. **Severity:** should-revisit-soon  
   **Location:** [MCP_SURFACE.md §historical](<operator-home>/Cairn/docs/MCP_SURFACE.md:199)  
...
5. **Severity:** must-fix-before-build  
   **Location:** [PRIMER.md §10](<operator-home>/Cairn/docs/PRIMER.md:452), [UAT_PIPELINE.md §5.1](<operator-home>/Cairn/docs/UAT_PIPELINE.md:169)  
...
6. **Severity:** must-fix-before-build  
   **Location:** [RESUME_PROMPT.md L26](<operator-home>/Cairn/RESUME_PROMPT.md:92), [FILESYSTEM_LAYOUT.md §4](<operator-home>/Cairn/docs/FILESYSTEM_LAYOUT.md:245)  
...
7. **Severity:** should-revisit-soon  
   **Location:** [WORKFLOW_GUIDE.md §1](<operator-home>/Cairn/docs/WORKFLOW_GUIDE.md:58), [WORKFLOW_GUIDE.md §4.3](<operator-home>/Cairn/docs/WORKFLOW_GUIDE.md:212)  
...
8. **Severity:** must-fix-before-build  
   **Location:** [INTEGRATION_PLAN.md Phase 16](<operator-home>/Cairn/docs/INTEGRATION_PLAN.md:431), [FILESYSTEM_LAYOUT.md §11](<operator-home>/Cairn/docs/FILESYSTEM_LAYOUT.md:596)  
...
9. **Severity:** should-revisit-soon  
   **Location:** [WORKFLOW_GUIDE.md §2.2](<operator-home>/Cairn/docs/WORKFLOW_GUIDE.md:115), [INTEGRATION_PLAN.md DoD](<operator-home>/Cairn/docs/INTEGRATION_PLAN.md:547)  
...
10. **Severity:** should-revisit-soon  
    **Location:** [WORKFLOW_GUIDE.md §5](<operator-home>/Cairn/docs/WORKFLOW_GUIDE.md:339), [UAT_PIPELINE.md §5.3](<operator-home>/Cairn/docs/UAT_PIPELINE.md:237)  
...
11. **Severity:** should-revisit-soon  
    **Location:** [PRIMER.md §11](<operator-home>/Cairn/docs/PRIMER.md:554), [PRIMER.md §14](<operator-home>/Cairn/docs/PRIMER.md:637)  
...
12. **Severity:** note-for-record  
    **Location:** [PRIMER.md §14](<operator-home>/Cairn/docs/PRIMER.md:638), [RESUME_PROMPT.md §6](<operator-home>/Cairn/RESUME_PROMPT.md:132)  
...
13. **Severity:** should-revisit-soon  
    **Location:** [RESUME_PROMPT.md L05](<operator-home>/Cairn/RESUME_PROMPT.md:71), [FILESYSTEM_LAYOUT.md §12](<operator-home>/Cairn/docs/FILESYSTEM_LAYOUT.md:618)  
