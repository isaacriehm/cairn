...
| `docs/design/mobile-deferred.md` | 95 | dual | **stale-supersedable** | `status: deferred, decision-date: 2026-04-16`. References `mobile/SampleProject/` which is gone. Lists "salvageable" Swift files — moot. | Replace with one-line decision: "mobile deferred; will be rebuilt fresh post-pilot." |
...
|---|---|---|
| **Product positioning** | `JAMESON-PRIME.md` · `docs/product/positioning.md` · `docs/design/design-context.md` · `docs/design/platform-rebuild-primer/01-product-and-design-context.md` | Same thesis, voice, and "other CRMs summarize, sample-project updates" line in 4 files. Drift risk per change. |
...
| Mobile/Swift app exists | `mobile-flows.md`, `mobile-deferred.md` | `find . -name SampleProject` | ✗ **deleted in commit `a3e26be`** |
...
Cluster duplication is heaviest around product framing (positioning + design-context + JAMESON-PRIME + 01-product-and-design-context all repeat the "other CRMs summarize, sample-project updates" thesis with slight drift) and AI subsystem architecture (`docs/engineering/ai-subsystem.md` 527 lines + `.claude/rules/ai-subsystem.md` 23 lines + `prompt-governance.md` 369 lines + ADR-0001 all touch the same write-path).
