...
| 9 | End-to-end smoke | Install plugin into a fresh test project (sample-project or a clean fixture), run full adoption, verify daily flow with a small task. |
| 10 | Pre-publish prep | gitleaks scan; content audit (sample-project references in BUILD_LOG, archives); operator decides on history wipe; fresh public repo with current clean working tree as initial commit. |
