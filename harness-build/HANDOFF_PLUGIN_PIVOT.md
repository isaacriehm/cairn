...
5. Memory: `~/.claude/projects/<project-key>/memory/MEMORY.md`. The entry titled "Cairn UX is invisible infrastructure" is load-bearing — read its body in full.
...
Cairn becomes a Claude Code plugin. Bundle:
