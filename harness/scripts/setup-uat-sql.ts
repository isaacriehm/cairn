...
function main(): number {
  ...
  if (driver === "sqlite") {
    ...
    if (!buildBinding) {
      console.log("  pnpm -F @isaacriehm/harness setup:uat-sql --build-binding");
    }
    console.log("  pnpm -F @isaacriehm/harness smoke:uat   # exercises sqlite when binding is built");
