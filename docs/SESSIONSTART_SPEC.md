...
{
  "session_id": "<uuid>",
  "transcript_path": "<operator-home>/.claude/projects/<slug>/<session>.jsonl",
  "cwd": "<operator-home>/<adopted-project>",
...
```
## Cairn MCP tools (quick reference)
...
- [ ] `pnpm -F @isaacriehm/harness-core test:smoke -- --filter=session-start` runs a fixture that:
