...
# Cairn — Claude Code Status Line Spec

Cairn registers a persistent status line inside every Claude Code session in an adopted project. It shows what the harness is doing at all times — present, readable at a glance, not in the way.
