...
│   ├── agents/
│   │   ├── sample-project-fixer/AGENT.md
│   │   ├── sample-project-reviewer/AGENT.md
│   │   ├── sample-project-staleness-scanner/AGENT.md
│   │   ├── sample-project-eval-runner/AGENT.md
│   │   ├── sample-project-spec-planner/AGENT.md
│   │   ├── sample-project-uat-runner/AGENT.md
│   │   └── sample-project-backprop-author/AGENT.md
│   ├── skills/                                                            CANONICAL
│   └── rules/*.md                                                         CANONICAL
...
```json
{
  ...
  "agent_role": "sample-project-fixer",
  "attempt": 1,
  ...
  "sha_pin": "9e3f4a2",
  "branch_pin": "main",
  "mirror_path": "<operator-home>/.local/harness/repos/sample-project",
  "discord_channel_id": "...",
  "discord_thread_id": "...",
  "tokens_input": 0,
  "tokens_output": 0,
